package io.github.mayconcardoso.boilerplate.generator.generators.feature

import io.github.mayconcardoso.boilerplate.generator.generators.feature.builder.*
...
import io.github.mayconcardoso.boilerplate.generator.core.settings.FeatureSettings
...
import io.github.mayconcardoso.boilerplate.generator.generators.feature.path.ModuleDefaultLayers
...
class FeatureGenerator(
  ...
  var domainEntityTemplateGenerator: FeatureEntityTemplate =
    EmptyEntityTemplate(domainModulePath)
  var domainServiceGenerator: FeatureServiceTemplate =
    ServiceInterfaceTemplate(domainModulePath)

  // Templates data Generators
  var dataServiceGeneratorImplTemplate: FeatureServiceImplTemplate =
    RepositoryTemplate(dataModulePath)
  var dataDataSourceTemplateGenerator: FeatureDataSourceTemplate =
    DataSourceInterfaceTemplate(dataModulePath)
  var dataLocalDataSourceTemplateGenerator: FeatureLocalDataSourceTemplate =
    LocalDataSourceTemplate(dataModulePath)
  var dataRemoteDataSourceTemplateGenerator: FeatureRemoteDataSourceTemplate =
    RemoteDataSourceTemplate(dataModulePath)
  var dataRetrofitAPITemplateGenerator: FeatureRetrofitAPITemplate =
    RetrofitAPITemplate(dataModulePath)

  // Template presentation Generators
  var presentationBuildGradle: FeaturePresentationBuildGradle =
    GradleModuleTemplate(featureModulePath)
  var presentationActivity: FeaturePresentationActivity =
    ActvityTemplate(featureModulePath)
  var presentationFragment: FeaturePresentationFragment =
    FragmentTemplate(featureModulePath)
  var presentationViewModel: FeaturePresentationViewModel =
